...
//
// Path: AppModels/AppModel+RestLogic.swift
//
// Purpose:
// - Provides Phase 1 rest-planning helpers, NHVR-style rest summaries, and rest-in-progress logic.
//
// Responsibilities:
// - Derive Phase 1 start-planning values from current-day work/rest data.
// - Expose NHVR-oriented work, rest, and short-rest summaries for UI and planning.
// - Provide provisional “rest in progress” helpers before a break qualifies as legal rest.
//
// Notes:
// - This is planning and interpretation logic, not a full fatigue-compliance engine.
// - Current implementation is single-day / pre-persistence and intentionally avoids rolling multi-day logic.
// - Post-persistence, this file may evolve into a richer rule-aware planning layer or split further.
//
// Phase: Pre-persistence
//======================================
//
//======================================
// MARK: - Phase 1 Planning Scope
//======================================
//
// Phase 1 goal:
// - Provide a simple “earliest next start” + “latest finish” planner
//   without rolling 24h / multi-day rules.
//
// Current assumptions:
// - “Legal rest today” = sum of rest segments ≥ 15 minutes
//   (see FatigueRules.swift).
...
//
// Important:
// - This is a planning heuristic only.
// - It is not a rolling 24h engine.
// - It will be refined in later persistence / fatigue phases.
//======================================
