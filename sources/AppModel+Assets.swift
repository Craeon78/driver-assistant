//======================================
// MARK: - AppModel+Assets
//======================================
//
// Path: AppModels/AppModel+Assets.swift
//
// Purpose:
// - Provides shared asset access and load account resolution logic.
//
// Responsibilities:
// - Expose static fuel product data to the app
// - Resolve load codes to load accounts and terminals
// - Maintain selection state for resolved load accounts
//
// Notes:
// - Acts as a bridge between legacy loadCode handling and resolver-based selection
// - Resolver logic must remain deterministic and tolerant of formatting (spaces, partial input)
// - UI should not rely on raw loadCode once resolvedLoadAccountID is set
// - Transitional file during migration from legacy loadCode handling
// - Will be split into Products, LoadResolution, and Selection modules post-persistence
//
